...
public class GenerateShortAudioDescriptionFromPlacesNameRestController extends RestControllerBase {
    ...
    protected String serviceName() {
        return "GenerateShortAudioDescriptionFromPlacesNameRestController";
    }
}
